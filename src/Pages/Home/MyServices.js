...
const MyServices = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
      <div className="p-4  flex flex-col bg-gradient-to-r from-sky-500 to-indigo-500 rounded-lg text-white text-center bg-slate-400  items-center">
        ...
        <div className="flex-grow">
          <h2 className="text-gray-900 text-lg title-font font-medium mb-3">Frontend Developer</h2>
          <p className="leading-relaxed text-base">As a frontend developer, my primary focus is on creating user-facing web applications and interfaces. I use a combination of programming languages such as HTML, CSS, and JavaScript to build and design interactive, visually appealing, and intuitive web pages that users can easily navigate and engage with. Additionally, I continuously stay up-to-date with the latest web development trends, technologies, and tools to provide the best user experience possible.</p>
      ...
      <div className="p-4  flex flex-col bg-gradient-to-r from-sky-500 to-indigo-500 rounded-lg text-white text-center items-center">
        <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-10 h-10" viewBox="0 0 24 24">
        ...
        <div className="flex-grow">
          <h2 className="text-gray-900 text-lg title-font font-medium mb-3">Backend Developer</h2>
          <p className="leading-relaxed text-base">As a backend developer, my primary responsibility is to design, develop, and maintain the server-side of web applications. This involves writing code that handles data storage, processing, and retrieval, as well as managing communication between the client-side and the server-side. I work with databases, APIs, and various technology, such as Node js, Express js, MongoDB, or Mongoose, depending on the project's requirements.</p>
          <a href='!#' className="mt-3 text-indigo-500 inline-flex items-center">Learn More
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
